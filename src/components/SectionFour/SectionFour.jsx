      ...
      <section className="section-four">
        ...
        <div className="pocket-to-pocket">
          <header>
            ...
            <p>
              No more credit alert delays. Transfer money to anyone on Pocket
              App and they will get it immediately.
            </p>
          </header>
          <img src={p2p} alt="" />
        </div>
        ...
        <div className="pay-bills">
          <header>
            <h1>Pay Bills</h1>
            <p>
              Never get disconnected. Find and settle all your bills in one
              place
            </p>
          </header>
          <img src={bills} alt="" />
